    ...
    listOf(
      Decade(
        ...
        artists = listOf(
          Artist(
            ...
            biography = "Lithographer to Queen Victoria and Prince " +
          ...
          Artist(
            ...
            biography = "Deaf brothers from Heilbronn, Louis (Ludwig)" +
      ...
      Decade(
        ...
        artists = listOf(
          Artist(
            name = "\u00C9mile Lassalle",
            biography = "A recipient of the French National Order of " +
          ...
          Artist(
            name = "Jule Arnout",
            biography = "Jule Arnout, pupil of his father, Jean " +
                "Baptiste Arnout, captured " + "landscapes, " +
          ...
          Artist(
            ...
            biography = "Serbian Jovanovi\u0107 is best known as a " +
      ...
      Decade(
        ...
        artists = listOf(
          Artist(
            ...
            biography = "Little is known about this French " +
      ...
      Decade(
        ...
        artists = listOf(
          Artist(
            ...
            biography = "The renowned post-impressionist painter " +
          ...
          Artist(
            ...
            biography = "A Spanish cartoonist, photographer and " +
